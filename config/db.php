...
return [
    // Dati rigurdanti i fumetti
    'comics' => [
        [
            "title" => "DC'S LEGION OF BLOOM",
        ...
        [
            "title" => "ROBIN VOL. 3: SECRETS AND SHADOWS ",
        ...
        [
            "title" => "HARLEY QUINN VOL. 3: VERDICT",
    ...
    // Dati della barra di navigazione nell'header
    'nav' => [
        'CHARACTERS',
        'COMICS',
        'MOVIES',
